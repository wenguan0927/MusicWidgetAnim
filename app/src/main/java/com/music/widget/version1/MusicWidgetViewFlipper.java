 ...
 */
@RemoteView
public class MusicWidgetViewFlipper extends ViewFlipper {
     ...
     * @param pContext
     */
    public MusicWidgetViewFlipper(Context pContext) {
        super(pContext);
    }
     ...
     * @param pAttrs
     */
    public MusicWidgetViewFlipper(Context pContext, AttributeSet pAttrs) {
    ...
    private void initViewPage() {
        ...
        mTitle01OneTxt.setTextColor(Color.WHITE);
        ...
        mTitle02OneTxt.setTextSize(TypedValue.COMPLEX_UNIT_DIP, 18);
        mTitle02OneTxt.setTextColor(Color.WHITE);
        ...
        mTitle01TwoTxt.setTextColor(Color.WHITE);
        ...
        mTitle02TwoTxt.setTextSize(TypedValue.COMPLEX_UNIT_DIP, 18);
        mTitle02TwoTxt.setTextColor(Color.WHITE);
    ...
    public void setShowContent(String pStrContent) {
        Log.v(TAG, "------->>setShowContent(),pStrContent:" + pStrContent);
    ...
    public void setAnimationMode(String pStrDirection) {
        Log.v(TAG, "------->>setAnimationMode(),pStrDirection:" + pStrDirection);
