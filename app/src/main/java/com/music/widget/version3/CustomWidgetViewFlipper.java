...
public class CustomWidgetViewFlipper extends ViewFlipper {
    ...
    private void initViewPage() {
        ...
        mTitle01OneTxt.setTextSize(TypedValue.COMPLEX_UNIT_DIP, 20);
        ...
        mTitle02OneTxt.setTextSize(TypedValue.COMPLEX_UNIT_DIP, 12);
        ...
        mTitle01TwoTxt.setTextSize(TypedValue.COMPLEX_UNIT_DIP, 20);
        ...
        mTitle02TwoTxt.setTextSize(TypedValue.COMPLEX_UNIT_DIP, 12);
